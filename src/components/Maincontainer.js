  ...
  return (
    <div className='w-screen h-auto '>
        <div className='absolute bg-gradient-to-r from-black w-screen aspect-video '>
               ...
               <button className='bg-white bg-opacity-90 cursor-pointer text-black p-4 px-16 ml-7 mt-4 rounded-lg text-lg cursor-pointer hover:bg-opacity-70 hidden md:inline-block'>▶ Play</button>
